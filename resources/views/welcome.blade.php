...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased" style="background-color: #DEFFE3;">
        <div class="relative flex items-top justify-center min-h-screen dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Escritorio de Usuario</a>
                    @else
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <a href="{{ route('dashboard') }}">
                        <img src="/img/logo2.png" alt="Logo ReciWeb" width="280" height="85">
                    </a>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                <div class="ml-4 text-lg leading-7 font-semibold">¿Por qué ReciWeb?</div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm" style="text-align: justify">
                                    ReciWeb se ha convertido en una solución a grandes dilemas sobre el cuidado ambiental ya que cuenta con un sistema de puntaje el cual aumenta debido al peso de las bolsas recolectadas por cada usuario.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                <div class="ml-4 text-lg leading-7 font-semibold">Objetivos</div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm" style="text-align: justify">
                                    Uno de los principales objetivos y por el cual fue creada, es incentivar a los usuarios a realizar el proceso de reciclaje de manera contínua ya que no solo traerá beneficios dentro del puntaje del hogar sino también habrán mejoras significativas en el medio ambiente de la región.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex items-center">
                                <div class="ml-4 text-lg leading-7 font-semibold">¿Qué tiene de especial?</div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            <div class="flex items-center">
                                <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Alcances</div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm" style="text-align: justify">
                                    ReciWeb está enfocada netamente dentro del departamento de Santander, pero esto no es una limitante para que en un futuro esta página web sea utilizada dentro de todo el país. La idea de ser un incentivo está enfocada de forma general para los habitantes de Colombia.
                                </div>
                            </div>
                        </div>
                    </div>
