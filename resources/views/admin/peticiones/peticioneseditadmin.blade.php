<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Editar Peticion desde Admin') }}
            @section('title', 'ReciWeb - Editar Peticion desde Admin')
        </h2>
    </x-slot>
    ...
    <div class="container-fluid px-1 py-5 mx-auto">
        <div class="row d-flex justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                <div class="card">
                    <form action="{{ url('/peticionesadmin/'.$peticiones->idpeticiones) }}" class="form-card" method="POST" >
                        @csrf
                        {{ method_field('PATCH') }}
